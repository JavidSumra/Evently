...
const SignInPage = () => {
  return (
    <div className="flex items-center justify-center w-screen h-screen font-poppins font-semibold">
      <div className="bg-white rounded-lg p-4">
        <img src={EventlyLogo} alt="Evently" className="w-[16%] mb-3" />
        <div className="text-2xl font-bold">Sign in</div>
        <div className="text-sm">to Continue to Evently</div>

        <div className="my-3 flex">
          <div className="google border rounded-lg p-2 w-fit mr-4">
            <svg
          ...
          <div className="github border rounded-lg p-2 w-fit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
        ...
        <div>
          <div className="flex flex-col">
            ...
            <input
              type="email"
              id="email"
              className="w-1/2 border rounded p-1 focus:outline-violet-600"
            />
          </div>
          <div className="flex flex-col">
        ...
        <div className="w-1/2 text-center">
          <button className="bg-violet-500 p-2 rounded-lg text-center my-3 w-full text-white">
            Continue
          </button>
        </div>
        <div className="text-sm">
          No Account?
          <Link to={""} className="text-violet-800 mx-2">
            Signup
          </Link>
        </div>
      </div>
