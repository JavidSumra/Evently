...
const SignupForm = () => {
  ...
  return (
    <>
      <Link to="/">
        <img src={EventlyLogo} alt="Evently" className="w-[25%] mb-3" />
      </Link>
      <div className="text-2xl font-bold">Create Your Account</div>
      <div className="text-sm">to Continue to Evently</div>

      <div className="my-3 flex">
        <div
          className="google border rounded-lg p-2 w-fit mr-4 cursor-pointer"
        ...
        <div
          className="github border rounded-lg p-2 w-fit cursor-pointer"
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex justify-between w-full items-center">
          <div className="flex flex-col mr-2">
            ...
            <input
              ...
              id="firstName"
              {...register("firstName")}
              className="w-full border rounded p-1 focus:outline-violet-400"
            />
          </div>
        ...
        <div className="w-full text-center font-bold">
          <button
            type="submit"
            className="bg-violet-500 hover:bg-violet-600  p-2 rounded-lg text-center my-3 w-full text-white"
          >
            Continue
          </button>
        </div>
      ...
      <div className="text-sm">
        Have An Account?
        <Link to="/signin" className="text-violet-800 mx-2 font-bold">
          Signin
        </Link>
      </div>
    </>
